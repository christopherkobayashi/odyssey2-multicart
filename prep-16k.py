...
if size == 2048:
  # One bank
  rom_image[0x0400:0x0c00] = in_rom[0x0000:0x0800]
  # One mirror for A10 lossage
  rom_image[0x0c00:0x1000] = rom_image[0x0800:0x0c00]
  # Replicate throughout 16k
  rom_image[0x1000:0x2000] = rom_image[0x0000:0x1000]
  rom_image[0x2000:0x4000] = rom_image[0x0000:0x2000]

elif size == 4096:
  # Two banks
  rom_image[0x0400:0x0c00] = in_rom[0x0000:0x0800]
  rom_image[0x1400:0x1c00] = in_rom[0x0800:0x1000]
  # Two mirrors for A10 lossage
  rom_image[0x0c00:0x1000] = rom_image[0x0800:0x0c00]
  rom_image[0x1c00:0x2000] = rom_image[0x1800:0x1c00]
  # Replicate throughout 16k
  rom_image[0x2000:0x4000] = rom_image[0x0000:0x2000]
  ...
  rom_image[0x0400:0x0c00] = in_rom[0x0000:0x0800]
  rom_image[0x1400:0x1c00] = in_rom[0x0800:0x1000]
  rom_image[0x2400:0x2c00] = in_rom[0x1000:0x1800]
  rom_image[0x3400:0x3c00] = in_rom[0x1800:0x2000]
  # Four mirrors for A10 lossage
  rom_image[0x0c00:0x1000] = rom_image[0x0800:0x0c00]
  rom_image[0x1c00:0x2000] = rom_image[0x1800:0x1c00]
  rom_image[0x2c00:0x3000] = rom_image[0x2800:0x2c00]
  rom_image[0x3c00:0x4000] = rom_image[0x3800:0x3c00]
